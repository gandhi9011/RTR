...
public class ApiHelperCallbyHalfnhour
{
    ...
    private static CallbyHalfnhourApiInterface REST_CLIENT;
    static
    {
        setupRestClient();
    }

    private ApiHelperCallbyHalfnhour() {
    }

    public static CallbyHalfnhourApiInterface get() {
        return REST_CLIENT;
    }
    ...
    private static void setupRestClient() {
        ...
        */
        ...
        REST_CLIENT = retrofit.create(CallbyHalfnhourApiInterface.class);
