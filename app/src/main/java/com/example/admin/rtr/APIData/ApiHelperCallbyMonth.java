...
public class ApiHelperCallbyMonth
{
    ...
    private static CallbyMonthApiInterface REST_CLIENT;
    static
    {
        setupRestClient();
    }

    private ApiHelperCallbyMonth() {
    }

    public static CallbyMonthApiInterface get() {
        return REST_CLIENT;
    }
    ...
    private static void setupRestClient() {
        ...
        */
        ...
        REST_CLIENT = retrofit.create(CallbyMonthApiInterface.class);
