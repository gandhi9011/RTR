...
public class ApiHelperHistoricCall
{
    ...
    private static HistoriccallApiInterface REST_CLIENT;
    static
    {
        setupRestClient();
    }

    private ApiHelperHistoricCall() {
    }

    public static HistoriccallApiInterface get() {
        return REST_CLIENT;
    }
    ...
    private static void setupRestClient() {
        ...
        */
        ...
        REST_CLIENT = retrofit.create(HistoriccallApiInterface.class);
