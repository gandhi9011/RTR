...
public class ApiHelperUnreturnCalls
{
    ...
    private static UnreturnCallsApiInterface REST_CLIENT;
    static
    {
        setupRestClient();
    }

    private ApiHelperUnreturnCalls() {
    }

    public static UnreturnCallsApiInterface get() {
        return REST_CLIENT;
    }
    ...
    private static void setupRestClient() {
        ...
        */
        ...
        REST_CLIENT = retrofit.create(UnreturnCallsApiInterface.class);
