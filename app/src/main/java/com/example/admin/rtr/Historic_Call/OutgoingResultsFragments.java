...
public class OutgoingResultsFragments extends Fragment
{
    ...
    public static AllResultFragments newInstance(int page) {
        Bundle args = new Bundle();
        args.putInt(ARG_PAGE, page);
        AllResultFragments fragment = new AllResultFragments();
        ...
        call.enqueue(new Callback<HistoricCallResponse>() {
            ...
            public void onResponse(Call<HistoricCallResponse> call, Response<HistoricCallResponse> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    {
                        if (obj.getType().equals("OUT") || obj.getType().equals("INT-OUT") )
                        {
                            objects1.add(obj);
                        }
                    }
