...
public class ApiHelperAgentList
{
    private static final String API_URL = "http://data.myossbss.com/api/v1/devices/";
    //http://data.myossbss.com/api/v1/devices/rtrtestqueue,BCTCARollover/
    private static AgentListApiInterface REST_CLIENT;
    static
    {
        setupRestClient();
    }

    private ApiHelperAgentList()
    {

    }

    public static AgentListApiInterface get() {
        return REST_CLIENT;
    }
    ...
    private static void setupRestClient() {
        ...
        */
        ...
        REST_CLIENT = retrofit.create(AgentListApiInterface.class);
